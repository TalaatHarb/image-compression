function [sizeInBits, coefficients] = compressBlock190524Color(matrix, rmseThreshold)
  ...
  if(calculateRMSE(decompressBlock190524Color(n, coefficients), matrix) > rmseThreshold)
    ...
    if(calculateRMSE(decompressBlock190524Color(n, coefficients), matrix) > rmseThreshold)
      ...
      for i = 1:4
        ...
        if(calculateRMSE(decompressBlock190524Color(n, temp), blocks(:, :, i)) > rmseThreshold)
          % Second order approximation
